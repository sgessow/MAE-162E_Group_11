...
smiData.Solid(1).mass = 141.58423296000004;  % kg
smiData.Solid(1).CoM = [-6.6613381477509392e-13 12.699999999999999 0];  % mm
smiData.Solid(1).MoI = [39468429.014467984 149074197.45792499 109620992.52407974];  % kg*mm^2
smiData.Solid(1).PoI = [0 2.2453105543718255e-09 0];  % kg*mm^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 63.712904832000014;  % kg
smiData.Solid(2).CoM = [254.00000000000006 95.25 -304.80000000000001];  % mm
smiData.Solid(2).MoI = [2227378.1456115739 3781661.6266900073 2062958.0748859206];  % kg*mm^2
smiData.Solid(2).PoI = [0 -5.2514416426507893e-10 246630.10608847879];  % kg*mm^2
smiData.Solid(2).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(2).opacity = 1;
smiData.Solid(2).ID = 'SimpleSteps*:*Default';
