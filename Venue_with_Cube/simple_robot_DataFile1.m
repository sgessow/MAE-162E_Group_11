...
smiData.RigidTransform(1).translation = [-7.2299999999999951 0 2.1000000000000005];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [4.4319171148192886 2.6228346456692808 1.2653543300000001];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [0.25000000000000006 -0.20000000000000032 0.25000000000000294];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [3.125 2.4228346456692798 0.20000000000000004];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [0.24999999999999883 -0.20000000000000029 0.25000000000000111];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(8).translation = [0.24999999999999825 -0.24999999999999881 -0.25000000000001499];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(19).translation = [1.0600000000000003 -4.9400000000000039 -0.24999999999999992];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(20).translation = [0.39000000000000062 -2.6090241078691179e-15 3.7747582837255322e-15];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(23).translation = [0.24999999999999981 -1.0153543299999996 2.6742806400000001];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(24).translation = [0.39000000000000146 8.9372953482325102e-15 8.4376949871511897e-15];  % in
smiData.RigidTransform(24).angle = 2.0943951023931953;  % rad
smiData.RigidTransform(24).axis = [-0.57735026918962595 -0.57735026918962562 0.57735026918962562];
smiData.RigidTransform(24).ID = 'F[simple_intake_arm-2:-:simple_wheel-5]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(25).translation = [0.25000000000000089 -1.0153543299999996 2.674280640000001];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(26).translation = [0.39000000000000157 -2.3314683517128287e-15 5.2180482157382357e-15];  % in
smiData.RigidTransform(26).angle = 2.0943951023931953;  % rad
smiData.RigidTransform(26).axis = [-0.57735026918962595 -0.57735026918962562 0.57735026918962562];
...
smiData.Solid(1).mass = 0.028879998475929206;  % kg
smiData.Solid(1).CoM = [0.15616237968352831 -2.7754340255749965 -0.24999999999999997];  % in
smiData.Solid(1).MoI = [0.068292852325626499 0.0012651472846890801 0.068394409926204561];  % kg*in^2
smiData.Solid(1).PoI = [0 0 0.0019480433095946774];  % kg*in^2
smiData.Solid(1).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(1).opacity = 1;
smiData.Solid(1).ID = 'simple_leg*:*Default';

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 0.013300000000000001;  % kg
smiData.Solid(2).CoM = [0.19499999999999998 0 0];  % in
smiData.Solid(2).MoI = [0.0038597712195424395 0.0021028024189335059 0.0021030379927473187];  % kg*in^2
smiData.Solid(2).PoI = [-7.5031246952745193e-07 0 0];  % kg*in^2
smiData.Solid(2).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(2).opacity = 1;
smiData.Solid(2).ID = 'simple_wheel*:*Default';
...
smiData.Solid(4).MoI = [0.022007177353250709 0.025265194623524067 0.031461826708840408];  % kg*in^2
smiData.Solid(4).PoI = [0.0021728927074770557 4.4351125018345352e-09 -1.1134747985166125e-08];  % kg*in^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(5).mass = 0.008132207341052626;  % kg
smiData.Solid(5).CoM = [0.25 0.084224744436141544 1.5775449062228317];  % in
smiData.Solid(5).MoI = [0.006787179292400543 0.0064950076135401186 0.00060168003001639481];  % kg*in^2
smiData.Solid(5).PoI = [0.00057650014110219555 0 0];  % kg*in^2
smiData.Solid(5).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(5).opacity = 1;
smiData.Solid(5).ID = 'simple_intake_arm*:*Default';
...
smiData.RevoluteJoint(1).Rz.Pos = 93.551362088691562;  % deg
smiData.RevoluteJoint(1).ID = '[simple_intake_body-1:-:simple_intake_arm-1]';

smiData.RevoluteJoint(2).Rz.Pos = 91.197703874880744;  % deg
smiData.RevoluteJoint(2).ID = '[simple_intake_body-1:-:simple_intake_arm-2]';

smiData.RevoluteJoint(3).Rz.Pos = -84.762753224508785;  % deg
...
smiData.RevoluteJoint(9).Rz.Pos = 75.554165213266117;  % deg
...
smiData.RevoluteJoint(11).Rz.Pos = -146.23240617243414;  % deg
smiData.RevoluteJoint(11).ID = '[simple_intake_arm-2:-:simple_wheel-5]';

smiData.RevoluteJoint(12).Rz.Pos = -136.15602647395778;  % deg
