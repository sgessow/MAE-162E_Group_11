...
MODEL                   = simple_robot
MODULES                 = simple_robot_9eb3ef65_1.c simple_robot_9eb3ef65_1_create.c simple_robot_9eb3ef65_1_setParameters.c simple_robot_9eb3ef65_1_asserts.c simple_robot_9eb3ef65_1_deriv.c simple_robot_9eb3ef65_1_checkDynamics.c simple_robot_9eb3ef65_1_asm_delegate.c simple_robot_9eb3ef65_1_sim_delegate.c simple_robot_9eb3ef65_1_mode_zero_crossings.c simple_robot_9eb3ef65_1_geometries.c simple_robot_9eb3ef65_1_gateway.c pm_printf.c rt_logging.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c rtGetInf.c rtGetNaN.c rt_nonfinite.c simple_robot.c simple_robot_capi.c simple_robot_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = simple_robot.exe
MAKEFILE                = simple_robot.mk
...
MASTER_ANCHOR_DIR       = 
START_DIR               = C:\Users\David\DOCUME~1\GitHub\MAE-162E\SIMPLE~1
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 37
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = simple_robot_ref.rsp
COMPILER_COMMAND_FILE     = simple_robot_comp.rsp
...
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\sm\ssci\lib\win64\sm_ssci_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\sm\ssci\lib\win64\sm_ssci_int_ert_vcx64.lib
!endif
!else
...
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\sm\core\lib\win64\sm_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\sm\core\lib\win64\sm_int_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) sm.lib
!endif
...
!if $(INTEGER_CODE) == 0
!if "$(MODELREF_TARGET_TYPE)" == "SIM"
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\sm\math\lib\win64\pm_math_rtwsfcn_vcx64.lib
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\sm\math\lib\win64\pm_math_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\sm\math\lib\win64\pm_math_int_ert_vcx64.lib
!endif
!else
...
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\simscape\engine\sli\lib\win64\ssc_sli_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\simscape\engine\sli\lib\win64\ssc_sli_int_ert_vcx64.lib
!endif
!else
...
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\simscape\engine\core\lib\win64\ssc_core_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\simscape\engine\core\lib\win64\ssc_core_int_ert_vcx64.lib
!endif
!else
...
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\common\math\core\lib\win64\mc_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\common\math\core\lib\win64\mc_int_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) mc.lib
!endif
...
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\common\external\library\lib\win64\ex_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\common\external\library\lib\win64\ex_int_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) ex.lib
!endif
...
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\common\foundation\core\lib\win64\pm_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\physmod\common\foundation\core\lib\win64\pm_int_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) pm.lib
!endif
