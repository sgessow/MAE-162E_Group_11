...
simple_robot_9eb3ef65_1_NeDaePrivateData_create ( NeDaePrivateData * smData )
; void simple_robot_9eb3ef65_1_dae ( NeDae * * dae , const NeModelParameters
...
simple_robot_9eb3ef65_1_NeDaePrivateData_create ( smData ) ; * dae =
