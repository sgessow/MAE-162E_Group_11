...
void simple_robot_9eb3ef65_1_resetSimStateVector ( const void * mech , double
...
; } static void perturbSimJointPrimitiveState_0_0 ( double mag , double *
...
21 ] = state [ 21 ] + mag ; } static void perturbSimJointPrimitiveState_5_0v
...
23 ] = state [ 23 ] + mag ; } static void perturbSimJointPrimitiveState_6_0v
( double mag , double * state ) { state [ 23 ] = state [ 23 ] + mag ; state [
24 ] = state [ 24 ] - 0.875 * mag ; } static void
perturbSimJointPrimitiveState_7_0 ( double mag , double * state ) { state [
25 ] = state [ 25 ] + mag ; } static void perturbSimJointPrimitiveState_7_0v
( double mag , double * state ) { state [ 25 ] = state [ 25 ] + mag ; state [
26 ] = state [ 26 ] - 0.875 * mag ; } static void
perturbSimJointPrimitiveState_8_0 ( double mag , double * state ) { state [
27 ] = state [ 27 ] + mag ; } static void perturbSimJointPrimitiveState_8_0v
( double mag , double * state ) { state [ 27 ] = state [ 27 ] + mag ; state [
28 ] = state [ 28 ] - 0.875 * mag ; } static void
perturbSimJointPrimitiveState_9_0 ( double mag , double * state ) { state [
29 ] = state [ 29 ] + mag ; } static void perturbSimJointPrimitiveState_9_0v
( double mag , double * state ) { state [ 29 ] = state [ 29 ] + mag ; state [
30 ] = state [ 30 ] - 0.875 * mag ; } static void
perturbSimJointPrimitiveState_10_0 ( double mag , double * state ) { state [
31 ] = state [ 31 ] + mag ; } static void perturbSimJointPrimitiveState_10_0v
( double mag , double * state ) { state [ 31 ] = state [ 31 ] + mag ; state [
32 ] = state [ 32 ] - 0.875 * mag ; } static void
perturbSimJointPrimitiveState_11_0 ( double mag , double * state ) { state [
33 ] = state [ 33 ] + mag ; } static void perturbSimJointPrimitiveState_11_0v
( double mag , double * state ) { state [ 33 ] = state [ 33 ] + mag ; state [
34 ] = state [ 34 ] - 0.875 * mag ; } static void
perturbSimJointPrimitiveState_12_0 ( double mag , double * state ) { state [
35 ] = state [ 35 ] + mag ; } static void perturbSimJointPrimitiveState_12_0v
...
} void simple_robot_9eb3ef65_1_constructStateVector ( const void * mech ,
...
35 ] ; fullState [ 36 ] = solverState [ 36 ] ; } void
...
fullState [ 29 ] ; solverState [ 30 ] = fullState [ 30 ] ; solverState [ 31 ]
= fullState [ 31 ] ; solverState [ 32 ] = fullState [ 32 ] ; solverState [ 33
] = fullState [ 33 ] ; solverState [ 34 ] = fullState [ 34 ] ; solverState [
35 ] = fullState [ 35 ] ; solverState [ 36 ] = fullState [ 36 ] ; } int
...
simple_robot_9eb3ef65_1_isVelocityViolation ( const void * mech , const
RuntimeDerivedValuesBundle * rtdv , const int * eqnEnableFlags , const double
* state , const int * modeVector ) { const double * rtdvd = rtdv -> mDoubles
. mValues ; const int * rtdvi = rtdv -> mInts . mValues ; ( void ) mech ; (
void ) rtdvd ; ( void ) rtdvi ; ( void ) eqnEnableFlags ; ( void ) state ; (
void ) modeVector ; return 0 ; } PmfMessageId
simple_robot_9eb3ef65_1_projectStateSim ( const void * mech , const
...
NeuDiagnosticManager * ) neDiagMgr0 ; double xx [ 1 ] ; ( void ) mech ; (
void ) rtdvd ; ( void ) rtdvi ; ( void ) eqnEnableFlags ; ( void ) modeVector
; ( void ) input ; ( void ) neDiagMgr ; xx [ 0 ] = 1.0 / sqrt ( state [ 3 ] *
state [ 3 ] + state [ 4 ] * state [ 4 ] + state [ 5 ] * state [ 5 ] + state [
6 ] * state [ 6 ] ) ; state [ 3 ] = xx [ 0 ] * state [ 3 ] ; state [ 4 ] = xx
[ 0 ] * state [ 4 ] ; state [ 5 ] = xx [ 0 ] * state [ 5 ] ; state [ 6 ] = xx
[ 0 ] * state [ 6 ] ; return NULL ; } void
...
) error ; } void simple_robot_9eb3ef65_1_resetModeVector ( const void * mech
, int * modeVector ) { ( void ) mech ; ( void ) modeVector ; } boolean_T
simple_robot_9eb3ef65_1_hasJointDisToNormModeChange ( const void * mech ,
const int * prevModeVector , const int * modeVector ) { ( void ) mech ; (
void ) prevModeVector ; ( void ) modeVector ; return 0 ; } PmfMessageId
simple_robot_9eb3ef65_1_performJointDisToNormModeChange ( const void * mech ,
const RuntimeDerivedValuesBundle * rtdv , const int * prevModeVector , const
