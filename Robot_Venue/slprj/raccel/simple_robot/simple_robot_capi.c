...
"simple_robot/Solver Configuration/EVAL_KEY/STATE_1" ) , TARGET_STRING ( "" )
, 0 , 0 , 0 , 0 , 0 } , { 0 , 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 , 0 , 0 } }
; static const rtwCAPI_BlockParameters rtBlockParameters [ ] = { { 0 , ( NULL
) , ( NULL ) , 0 , 0 , 0 } } ; static const rtwCAPI_ModelParameters
rtModelParameters [ ] = { { 0 , ( NULL ) , 0 , 0 , 0 } } ;
#ifndef HOST_CAPI_BUILD
static void * rtDataAddrMap [ ] = { & rtB . p1hd1pok3k [ 0 ] , } ; static
...
37 , 1 } ; static const real_T rtcapiStoredFloats [ ] = { 0.0 } ; static
...
, rtSampleTimeMap , rtDimensionArray } , "float" , { 1268878109U ,
2331143320U , 480976602U , 1733931079U } , ( NULL ) , 0 , 0 } ; const
rtwCAPI_ModelMappingStaticInfo * simple_robot_GetCAPIStaticMap ( void ) {
return & mmiStatic ; }
#ifndef HOST_CAPI_BUILD
void simple_robot_InitializeDataMapInfo ( void ) { rtwCAPI_SetVersion ( ( *
