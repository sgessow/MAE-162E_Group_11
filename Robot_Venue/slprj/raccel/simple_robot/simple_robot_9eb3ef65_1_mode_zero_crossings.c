...
const NeZCData * simple_robot_9eb3ef65_1_ZCData = NULL ; PmfMessageId
simple_robot_9eb3ef65_1_computeAsmModeVector ( const double * input , const
...
simple_robot_9eb3ef65_1_computeSimModeVector ( const double * input , const
double * inputDot , const double * inputDdot , int * modeVector , double *
errorResult , NeuDiagnosticManager * neDiagMgr ) { ( void ) input ; ( void )
inputDot ; ( void ) inputDdot ; ( void ) modeVector ; ( void ) neDiagMgr ;
errorResult [ 0 ] = 0.0 ; return NULL ; } PmfMessageId
simple_robot_9eb3ef65_1_computeZeroCrossings ( const
