...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [0.249999999999999 -0.20000000000000018 0.25000000000000011];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [0.24999999999998512 -0.20000000000000018 0.24999999999994121];  % in
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(8).translation = [0.24999999999999831 -0.25000000000000039 -0.25];  % in
...
smiData.RigidTransform(15).ID = 'B[simple_leg-3:-:simple_drive_wheel-1]';
...
smiData.RigidTransform(16).ID = 'F[simple_leg-3:-:simple_drive_wheel-1]';
...
smiData.RigidTransform(17).ID = 'B[simple_leg-5:-:simple_drive_wheel-2]';
...
smiData.RigidTransform(18).ID = 'F[simple_leg-5:-:simple_drive_wheel-2]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(19).translation = [1.0600000000000003 -4.9400000000000039 -0.25000000000000011];  % in
...
smiData.RigidTransform(19).ID = 'B[simple_leg-1:-:simple_drive_wheel-3]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(20).translation = [0.39000000000000068 -1.9290125052862095e-15 -3.3306690738754696e-15];  % in
...
smiData.RigidTransform(20).ID = 'F[simple_leg-1:-:simple_drive_wheel-3]';
...
smiData.RigidTransform(21).ID = 'B[simple_leg-2:-:simple_drive_wheel-4]';
...
smiData.RigidTransform(22).ID = 'F[simple_leg-2:-:simple_drive_wheel-4]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(23).translation = [0.24999999999999981 -1.0153543300000007 2.6742806399999997];  % in
...
smiData.RigidTransform(23).ID = 'B[simple_intake_arm-2:-:simple_intake_wheel-1]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(24).translation = [-8.8817841970011261e-16 3.522330374541521e-14 4.1197501132078072e-14];  % in
...
smiData.RigidTransform(24).ID = 'F[simple_intake_arm-2:-:simple_intake_wheel-1]';
...
smiData.RigidTransform(25).ID = 'B[simple_intake_arm-1:-:simple_intake_wheel-2]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(26).translation = [-8.8817841970012681e-16 -1.6109788878912202e-14 -4.5205823087532263e-14];  % in
...
smiData.RigidTransform(26).ID = 'F[simple_intake_arm-1:-:simple_intake_wheel-2]';
...
smiData.Solid(1).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(1).opacity = 1;
smiData.Solid(1).ID = 'simple_drive_wheel*:*Default';

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 0.008132207341052626;  % kg
smiData.Solid(2).CoM = [0.25 0.084224744436141544 1.5775449062228317];  % in
smiData.Solid(2).MoI = [0.006787179292400543 0.0064950076135401186 0.00060168003001639481];  % kg*in^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(3).mass = 0.028879998475929206;  % kg
smiData.Solid(3).CoM = [0.15616237968352831 -2.7754340255749965 -0.24999999999999997];  % in
smiData.Solid(3).MoI = [0.068292852325626499 0.0012651472846890801 0.068394409926204561];  % kg*in^2
smiData.Solid(3).PoI = [0 0 0.0019480433095946774];  % kg*in^2
smiData.Solid(3).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(3).opacity = 1;
smiData.Solid(3).ID = 'simple_leg*:*Default';

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(4).mass = 0.051970583852045921;  % kg
smiData.Solid(4).CoM = [1.6874998531926937 1.9044020185767141 0.64487339891285933];  % in
smiData.Solid(4).MoI = [0.022007177353250699 0.02526519462352406 0.031461826708840394];  % kg*in^2
smiData.Solid(4).PoI = [0.002172892707477057 4.4351125024455421e-09 -1.1134747989752409e-08];  % kg*in^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(5).mass = 0.013300000000000001;  % kg
smiData.Solid(5).CoM = [0.19499999999999998 0 0];  % in
smiData.Solid(5).MoI = [0.0038597712195424395 0.0021028024189335059 0.0021030379927473187];  % kg*in^2
smiData.Solid(5).PoI = [-7.5031246952745193e-07 0 0];  % kg*in^2
smiData.Solid(5).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(5).opacity = 1;
smiData.Solid(5).ID = 'simple_intake_wheel*:*Default';

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(6).mass = 1.7892999999999999;  % kg
smiData.Solid(6).CoM = [-5.4110236220472432 1.4846456685826774 4.3425196850393712];  % in
smiData.Solid(6).MoI = [21.618058574719416 18.193930284049433 35.902957356123579];  % kg*in^2
smiData.Solid(6).PoI = [1.8278926995325433 -0.63065966404074036 2.9989464940304811];  % kg*in^2
smiData.Solid(6).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(6).opacity = 1;
smiData.Solid(6).ID = 'simple_body*:*Default';
...
smiData.RevoluteJoint(1).Rz.Pos = 90.159592969431685;  % deg
smiData.RevoluteJoint(1).ID = '[simple_intake_body-1:-:simple_intake_arm-1]';

smiData.RevoluteJoint(2).Rz.Pos = 89.744801003768245;  % deg
smiData.RevoluteJoint(2).ID = '[simple_intake_body-1:-:simple_intake_arm-2]';

smiData.RevoluteJoint(3).Rz.Pos = -90.389504364549083;  % deg
...
smiData.RevoluteJoint(7).ID = '[simple_leg-3:-:simple_drive_wheel-1]';

smiData.RevoluteJoint(8).Rz.Pos = 108.1006322728355;  % deg
smiData.RevoluteJoint(8).ID = '[simple_leg-5:-:simple_drive_wheel-2]';

smiData.RevoluteJoint(9).Rz.Pos = -141.13174722922727;  % deg
smiData.RevoluteJoint(9).ID = '[simple_leg-1:-:simple_drive_wheel-3]';

smiData.RevoluteJoint(10).Rz.Pos = -22.522673585934783;  % deg
smiData.RevoluteJoint(10).ID = '[simple_leg-2:-:simple_drive_wheel-4]';

smiData.RevoluteJoint(11).Rz.Pos = -56.74740958418986;  % deg
smiData.RevoluteJoint(11).ID = '[simple_intake_arm-2:-:simple_intake_wheel-1]';

smiData.RevoluteJoint(12).Rz.Pos = 17.466074882506369;  % deg
smiData.RevoluteJoint(12).ID = '[simple_intake_arm-1:-:simple_intake_wheel-2]';
